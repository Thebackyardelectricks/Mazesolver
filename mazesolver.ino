  ...
  { 
    ...
    for(int i=0;i<=2;i++){Serial.print(dir[i]);} 
      ...
      for(int i=0;i<=4;i++) 
      {
        ...
        Serial.print("frontdistance: "); Serial.println(fdist);
        ...
        { 
         if(found==false)
            { 
             ...
             /*Serial.print("for the jth turn ..");Serial.print(" =");Serial.print(j); Serial.print(" the i value is ");Serial.print(i);Serial.print("and the dir is ..");Serial.println(dir[i]);*/ 
